...
#pragma mark MJBag类中的name属性不参与归档
    [IWUser mj_setupIgnoredCodingPropertyNames:^NSArray *{
        return @[@"vip",@"mbtype",@"mbrank"];
    }];
...
//        return @{
//                 @"pic_urls" : @"IWPhoto", // @"statuses" : [MJStatus class],
...
//    }];
    ...
    [IWStatusResult mj_setupObjectClassInArray:^NSDictionary *{
        return @{
                 @"statuses" : @"IWStatus", // @"statuses" : [MJStatus class],
                 };
    }];
...
#pragma mark ....
//    [IWUser mj_setupReplacedKeyFromPropertyName:^NSDictionary *{
//        return @{
//                 @"desc" : @"desciption",
